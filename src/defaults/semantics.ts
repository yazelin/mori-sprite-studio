...
export const DEFAULT_STATE_SEMANTICS: Record<StateName, string> = {
  ...
  recording:
    'wide open alert eyes (round and bright), open joyful smile showing teeth, one hand raised up beside the ear in an "I am listening" cupped-hand gesture, light motion lines or small sparkles around the figure to suggest attentive energy, animated and engaged',
